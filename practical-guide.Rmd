...
If reproducable and open science is something you are interested in have a look at this paper from [Lowndes et al. 2017](https://www.nature.com/articles/s41559-017-0160) and this blog post on [Tidy Data for reproducibility, efficiency and collaboration](https://www.openscapes.org/blog/2020/10/12/tidy-data/).
...
One option might be to try a polar stereographic projection, although the Gulf of St Lawrence isn't really "polar":
`"proj=stere"`
...
If you are looking for some more tips, Robin Lovelace has a fantastic book on Geocomputation with R that you can access for free here:
